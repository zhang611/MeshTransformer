...
def get_seq_random_walk_random_global_jumps(mesh_extra, f0, seq_len):
    ...
    n_vertices = mesh_extra['face_center'].shape[0]       # 顶点的数量 27648
    ...
    for i in range(1, seq_len + 1):
        ...
        nodes_to_consider = [n for n in this_nbrs if not visited[n]]  # 备选顶点 [5, 6, 11, 14, 17] 这句代码，首先-1会被去掉因为visited[-1] = True，其次用过的点也是true
